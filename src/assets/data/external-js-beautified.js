! function(e, t) {
    ...
    return function(e) {
        ...
        e.exports = function(e) {
            ...
            }), 50), h.listen("__ready__", (function(e) {
                if (e === d) {
                    clearInterval(t), l = !0;
        ...
        function R(e, t = {}) {
            return p(function(e) {
                ...
                url: `https://${e}/#jitsi_meet_external_api_id=${S}`
            }))
        }
        ...
        class D extends r.a {
            constructor(e, ...t) {
                ...
                }), Array.isArray(h) && h.length > 0 && this.invite(h), this._tmpE2EEKey = f, this._isLargeVideoVisible = !0, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), S++
            }
            _createIFrame(e, t, n) {
